...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-4xl font-extrabold mb-10 text-center bg-gradient-to-tr from-blue-600 to-purple-700 bg-clip-text text-transparent">
          Login
        </h2>
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-blue-600 to-purple-700 text-white py-4 rounded-3xl
                     font-semibold hover:from-purple-700 hover:to-blue-600 shadow-lg transition-all duration-300
                     active:scale-95"
        >
          Login
        </button>
